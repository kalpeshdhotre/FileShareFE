	...
	return (
		<div className="">
			...
			<section className="bg-white text-center py-12 px-4">
				<h2 className="text-4xl font-bold mb-4">Simplified File Sharing for Everyone</h2>
				<p className="text-xl mb-6">Upload, share, and access files with ease</p>
			...
			<section className="bg-gray-100 text-center py-12 px-4">
				<h2 className="text-3xl font-bold mb-8">What makes Share Pod special?</h2>
				...
				<div className="flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8">
					...
					<div className="md:w-1/3">
						<div className="bg-gray-100 h-52 p-6 rounded-lg shadow-lg">
							...
							<h3 className="text-xl font-bold mb-2">Get your shareable link</h3>
